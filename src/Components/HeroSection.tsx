    ...
    <aside className="w-full md:w-72 shrink-0 md:h-screen md:sticky md:top-0 border-b md:border-b-0 md:border-r border-base-300 bg-base-200 flex flex-col justify-between gap-6 p-6 relative overflow-hidden">
      ...
      <div className="relative">
        ...
        <div className="flex flex-col">
          ...
          <a href="https://www.linkedin.com/in/nate-mills-bb1345148/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 py-2 border-b border-base-300 text-base-content/80 hover:text-base-content transition-colors">
